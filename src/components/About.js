...
class About extends Component {
  render() {
    return <ScrollSection name="about">
        <div className="flex flex-col lg:flex-row w-full mb-10 space-y-10 lg:space-x-10 lg:space-y-0">
        ...
        <div className="bg-gradient-to-br from-indigo-500 to-indigo-800 rounded-xl px-7 py-9 mb-10 text-left">
