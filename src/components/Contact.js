        ...
        <section className="bg-gradient-to-br from-gray-200 to-gray-300 mb-10 rounded-xl">
          <div className="relative">
            <div className="grid grid-cols-1 lg:grid-cols-3">
              ...
              {/* Contact information */}
              <div className="relative overflow-hidden py-9 px-7 bg-indigo-800 rounded-l-xl">
                ...
                <h1 className="text-2xl leading-5 font-semibold font-heading text-white mb-5">Contact information</h1>
                <p className="mt-6 text-base text-indigo-50 max-w-3xl">Nullam risus blandit ac aliquam justo ipsum. Quam mauris volutpat massa dictumst amet. Sapien tortor lacus arcu.</p>
