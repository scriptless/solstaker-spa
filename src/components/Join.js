    ...
    <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        ...
        <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
                ...
                <td className="flex items-center space-x-2 px-6 py-4 whitespace-nowrap text-sm text-gray-500">
...
const JoinDetails = props => {
    return (<div className="flex flex-col items-center w-auto">
            <img className="h-14 w-14 mb-8" src={process.env.PUBLIC_URL + "/logos/exchange-white.svg"} alt=""/>
            <JoinDetailsTable/>
            <JoinDetailsAddressTable/>
            <span className="mt-8 text-gray-400 cursor-pointer" onClick={() => props.setOpen(false)}>
...
const JoinMarkup = () => {
    ...
    return (<ScrollSection name="join" className="px-7 py-16 rounded-xl border border-1 border-gray-700 mb-10 bg-gradient-to-tr from-gray-800 to-indigo-900">
                {isOpen ? 
