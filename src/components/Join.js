...
class Features extends Component {
  render() {
    return <section class="px-7 py-16 rounded-xl border border-1 border-gray-700 mb-10 bg-gradient-to-tr from-gray-800 to-indigo-900">
        <div class="flex flex-col items-center">
            <img class="h-20 w-20 mb-5" src={process.env.PUBLIC_URL + "/logos/exchange-white.svg"} alt=""/>
